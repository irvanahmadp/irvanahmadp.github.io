...
const ProjectLayout: FC<ProjectLayoutProps> = ({ children }) => {
  ...
  return (
    <>
      ...
      <Nav />
      <Setting />
      <main className="flex min-h-last-content flex-col justify-between bg-slate-100 dark:bg-slate-700 md:min-h-last-content-md md:py-8 md:px-16 lg:flex-row xl:px-32">
        ...
        <aside className="sticky h-auto w-full divide-y divide-slate-300 self-baseline border-y border-slate-300 bg-white dark:divide-slate-700 dark:border-slate-600 dark:bg-slate-800 md:rounded-lg md:border lg:top-28 lg:w-[32rem]">
