              ...
              <div className="card-body">
                <div className="flex gap-2 items-center">
                  {article.tags.map((tag, i) => (
                    <div
                      key={i}
                      className="badge badge-outline badge-success badge-sm rounded-sm"
                    >
                      {tag}
                    </div>
                  ))}
                ...
                <h3 className="font-medium text-lg tracking-tight group-hover:underline decoration-zinc-500/50 underline-offset-2">
                  {article.title}
                </h3>
                <p className="text-slate-300 text-base">{article.desc}</p>
