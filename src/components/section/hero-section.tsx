    ...
    <div className="min-h-screen">
      <section className="pt-14 pb-12 md:pt-20 md:pb-16 gap-8 flex flex-col md:flex-row">
        <div className="flex-1">
          ...
          >
            I’m Irvan, a developer who loves building clean, modern apps that
            make a real impact. I care about the small details that enhance user
            experience. I focus on web development — building APIs, front-end
          ...
          >
            <a href="#projects" className="btn btn-primary">
              <SparklesIcon className="size-4" /> Explore Project
            </a>
            <a href="#about" className="btn btn-outline">
              <SendIcon className="size-4" /> Say Hello
            </a>
          </motion.div>
        </div>
