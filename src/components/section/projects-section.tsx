        ...
        <div className="flex flex-col space-y-4 md:flex-row justify-between">
          ...
          <div className="flex gap-1.5 justify-center">
            ...
            <button
              ...
              className={cn(
                "btn btn-xs rounded-4xl",
                category === "Website" ? "btn-primary" : "btn-outline",
              )}
            >
              Website
            </button>
            <button
              ...
              className={cn(
                "btn btn-xs rounded-4xl",
                category === "API" ? "btn-primary" : "btn-outline",
              )}
            >
              API
            </button>
            <button
              ...
              className={cn(
                "btn btn-xs rounded-4xl",
                category === "Mobile" ? "btn-primary" : "btn-outline",
              )}
            >
              Mobile
            </button>
            ...
            return (
              ...
              >
                ...
                <div className="card-body">
                  ...
                  <div className="flex gap-2">
                    {project.code && (
                      <a href={project.code} className="btn btn-xs btn-primary">
